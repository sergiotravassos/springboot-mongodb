package com.sergiotravassos.springmongodb.resources.exception;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> objetNotfound(ObjectNotFoundException e, HttpServletRequest request) {
