...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c2 = new CommentDTO("Teste comentario 2 no post 1", sdf.parse("21/03/2022"), new AuthorDTO(bob));
		CommentDTO c3 = new CommentDTO("Teste comentario 3 em post 2", sdf.parse("21/03/2022"), new AuthorDTO(alex));
